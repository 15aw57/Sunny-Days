...
fullseqAA<-sapply(seqDF$seq,strsplit,split="")
names(fullseqAA)<-seqDF$`WNV Variant`  # Removed paste bc it wasn't conserving the sequence names and was affecting my distance matrix visualization.
fullseqAA<- as.AAbin(seqAA)
```
