...
CT = ggtree(TreeC, branch.length = "none")+
  geom_tiplab(size = 2.75)+ #Decrease tip label size
  xlim(NA,60)+  #Shift phylogeny to the left
  geom_hilight(node=173, fill="blue", alpha = 0.2) + #highlight distinct groupings in phylogeny
  geom_hilight(node=145, fill="purple", alpha = 0.2)+ 
  geom_hilight(node=159, fill="gold", alpha = 0.2)
